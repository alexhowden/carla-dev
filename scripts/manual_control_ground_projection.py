#!/usr/bin/env python
"""
Manual drive + SegFormer segmentation + Inverse Perspective Mapping (IPM) bird's-eye view.
...
Usage:
    ...
    python scripts/manual_control_ground_projection.py --bev-x 12 --bev-ymin 2 --bev-ymax 30
...
def main():
    parser = argparse.ArgumentParser(
        description="Manual drive (WASD) + SegFormer + Bird's Eye View ground projection."
    )
    parser.add_argument("--host", default="127.0.0.1", help="CARLA server host")
    parser.add_argument("--port", type=int, default=2000, help="CARLA server port")
    parser.add_argument("--map", metavar="NAME", default=None,
                        help="Load this map (e.g. Town01, Town02).")
